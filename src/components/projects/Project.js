    ...
    <article className="project animate__animated animate__fadeIn" data-id={id}>
      ...
      <div className="project_info">
        ...
        <div className="project_icons">
          <a href={githubLink} target="_blank" rel="noopener noreferrer"><i className="fas fa-code"></i></a>
          <a href={webLink} target="_blank" rel="noopener noreferrer"><i className="fas fa-desktop"></i></a>
        </div>
      </div>
    </article>
  );
